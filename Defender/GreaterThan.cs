...
public static partial class Guard {
	/// <summary>
	/// Asserts that the object is greater than an expected value.
	/// </summary>
	...
	[Conditional("DEBUG")]
	public static void GreaterThan<TActual, TExpected>(TActual actual, TExpected expected
		...
		if (actual.CompareTo(expected) <= 0) {
			throw new GuardException("The object"
				...
				+ $" '{expression}'"
#endif
				+ $" was not greater than what was expected.\nActual: {actual}\nExpected: {expected}");
		}
	}
}
