...
public static partial class Guard {
	/// <summary>
	/// Asserts that the object is lesser than or equal to an expected value.
	/// </summary>
	...
	[Conditional("DEBUG")]
	public static void LesserThanOrEqualTo<TActual, TExpected>(TActual actual, TExpected expected
		...
		if (actual.CompareTo(expected) > 0) {
			throw new GuardException("The object"
				...
				+ $" '{expression}'"
#endif
				+ $"was not lesser than or equal to what was expected.\nActual: {actual}\nExpected: {expected}");
		}
	}
}
