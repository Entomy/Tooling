...
namespace System.Text.Unicode {
	...
	internal static class TextSegmentationUtility {
		...
		/// </summary>
		internal static Int32 GetLengthOfFirstExtendedGraphemeCluster(ReadOnlySpan<Char> input) {
		...
		private ref struct Processor {
			...
			public Int32 CurrentCodeUnitOffset { get; private set; }
			...
			public void MoveNext() {
				...
				_ = Rune.DecodeFromUtf16(_buffer.Slice(CurrentCodeUnitOffset), out Rune thisRune, out _codeUnitLengthOfCurrentScalar);
				CurrentType = GraphemeSegmentationTable.GetGraphemeClusterBreakType(thisRune);
			}
		}
	}
}
