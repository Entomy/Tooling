...
public static partial class NumbersomeExtensions {
	...
	/// <remarks>This operation is meant to perform an unsigned (otherwise known as a logical) right shift on all types.</remarks>
	[ExcludeFromCodeCoverage]
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static T UnsignedShiftRight<T>(this T value, Int32 amount) where T : IShiftOperators<T, Int32, T> => value >>> amount;
}
