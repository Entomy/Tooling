...
public readonly struct Percent<T> :
	...
	/// </remarks>
	private static readonly T OneHundred = (T.One + T.One + T.One + T.One + T.One + T.One + T.One + T.One + T.One + T.One) * (T.One + T.One + T.One + T.One + T.One + T.One + T.One + T.One + T.One + T.One);
