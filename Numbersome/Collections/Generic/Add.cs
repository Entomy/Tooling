...
public static partial class NumbersomeExtensions {
	...
	/// </summary>
	/// <typeparam name="T">A numeric of <see cref="IAdditionOperators{TSelf, TOther, TResult}"/>.</typeparam>
	...
	public static void Add<T>([NotNull] this Stack<T> stack) where T : IAdditionOperators<T, T, T> {
		if (stack is null) {
